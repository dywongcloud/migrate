...
|-----------|---|----|-----|-----|-----------|--------------|------|
| 128 MiB | 100 | 100 | 324 ms | 551 ms | **688 ms** | 660 ms | ✅ |
| 256 MiB | 100 | 100 | 536 ms | 650 ms | **840 ms** | 760 ms | ✅ |
| 512 MiB | 100 | 100 | 1052 ms | 1805 ms | **2386 ms** | 1993 ms | ✅ |
| 1024 MiB | 100 | 98 | 1890 ms | 3756 ms | **4026 ms** | 3865 ms | ✅ (p99) |

p99 scales ~linearly with guest RAM (snapshot serialization + restore both scale
with memory); the 20 s envelope holds with >4× margin even at 1 GiB. The 2 misses
...
swap is ~2× the guest RAM (source + restored instance coexist briefly), so size the
host accordingly.
